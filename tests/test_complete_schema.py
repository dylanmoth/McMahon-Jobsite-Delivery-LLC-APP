...
EXPECTED_TABLES = {
    ...
    "devices", "audit_events", "app_settings", "customers", "contacts", "addresses",
    "customer_contacts", "customer_addresses", "customer_delay_incidents", "customer_notes",
    ...
    "geofence_versions", "route_snapshots", "communications", "number_sequences",
...
def test_primary_models_are_mapped(database) -> None:
    with database.session_factory() as session:
        for model in (
            User, Customer, Supplier, Driver, Vehicle, Quote, Job, Invoice, Payment,
