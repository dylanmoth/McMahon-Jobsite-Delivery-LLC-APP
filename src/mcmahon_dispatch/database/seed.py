...
PERMISSIONS: Final[dict[str, tuple[str, str, str]]] = {
    ...
    "dashboard.financial": ("View financial dashboard", "View financial dashboard metrics", "dashboard"),
    "quotes.read": ("Read quotes", "Read quotes and revisions", "quotes"),
    "quotes.write": ("Manage quotes", "Create and edit quotes", "quotes"),
    "quotes.override_price": ("Override pricing", "Override calculated pricing with audit", "quotes"),
    ...
    "billing.write": ("Manage billing", "Create and update invoices, payments, and expenses", "billing"),
    ...
    "users.manage": ("Manage users", "Manage users, roles, devices, and sessions", "administration"),
    "settings.manage": ("Manage settings", "Manage organization and application settings", "administration"),
...
ROLE_PERMISSION_CODES: Final[dict[str, set[str]]] = {
    ...
    "dispatcher": {
        "dashboard.view", "dashboard.financial", "quotes.read", "quotes.write",
        "dispatch.read", "dispatch.manage", "customers.read", "customers.write",
        "suppliers.read", "suppliers.write", "fleet.read", "billing.read", "billing.write",
        "documents.read", "documents.write", "reports.operational",
    },
    "driver": {"dashboard.view", "dispatch.read", "customers.read", "documents.read", "documents.write"},
    "accounting": {
        "dashboard.view", "dashboard.financial", "quotes.read", "customers.read",
        "billing.read", "billing.write", "documents.read", "reports.operational",
        "reports.financial", "audit.read",
    },
    "auditor": {
        "dashboard.view", "quotes.read", "dispatch.read", "customers.read", "suppliers.read",
        "fleet.read", "billing.read", "documents.read", "reports.operational", "audit.read",
    },
}
